...
namespace ApplicationName.ModelsAndFacilities.Facilities.Builders
{
    public class AppUriBuilder
    {
        ...
        public AppUriBuilder WithPathParameter(string key, string value)
        {
            ...
            _pathParameters.AddOrReplace(key, value);
        ...
        {
            Dictionary<string, StringValues>? queryStringKeysValues = QueryHelpers.ParseNullableQuery(_uriBuilder.Query);
