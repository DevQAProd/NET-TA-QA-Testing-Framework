...
{
    [Route("api/v1/YahooFinanceNoAuth")]
    [ApiController]
    public class YahooFinanceControllerNoAuthV1 : ControllerBase
    {
        private readonly IQuoteRepository _quoteRepository;

        public YahooFinanceControllerNoAuthV1(IQuoteRepository quoteRepository)
        {
        ...
        public async Task<ActionResult<IEnumerable<QuoteApiModel>>> GetQuoteRecordsByDateRange(Quote quote, Frequency frequency, DateTime? from, DateTime? to)
        {
            to ??= DateTime.UtcNow;
        ...
        public async Task<ActionResult<int>> PostOrPutQuoteRecords(Quote quote, Frequency frequency, [FromBody] QuoteApiModel[] quotes)
        {
        ...
        public async Task<ActionResult<int>> DeleteQuoteRecords(Quote quote, Frequency frequency, [FromBody] DateTime[] dateTimeValues)
        {
            if (!ModelState.IsValid)
